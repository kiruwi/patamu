  ...
  return (
    <section className="social-row reveal">
      ...
      <article className="social-grid">
        <a
          className="social-link image-social-two"
          href={instagramUrl}
          target="_blank"
          rel="noreferrer"
          aria-label="Visit Patamu Lodge on Instagram (image 1)"
        >
        ...
        <a
          className="social-link image-social-three"
          href={instagramUrl}
          target="_blank"
          rel="noreferrer"
          aria-label="Visit Patamu Lodge on Instagram (image 2)"
        >
          <span className="social-link__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" role="presentation" focusable="false">
              <path
        ...
        <a
          className="social-link image-social-four"
          href={instagramUrl}
          target="_blank"
          rel="noreferrer"
          aria-label="Visit Patamu Lodge on Instagram (image 3)"
        >
          <span className="social-link__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" role="presentation" focusable="false">
              <path
